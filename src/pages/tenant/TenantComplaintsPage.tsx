    ...
    <main className="flex-1 p-4 lg:p-6 xl:p-8 space-y-4 xl:space-y-6 mx-auto w-full max-w-none relative z-10">
      ...
      <div className="space-y-4 xl:space-y-6 pb-24 w-full">
        ...
        <div className="grid grid-cols-5 gap-6">
          <div className="backdrop-blur-xl bg-white/70 p-6 rounded-xl border border-gray-200 shadow hover:shadow-lg transition">
        ...
        {/* Status Filter */}
        <div className="backdrop-blur-xl bg-white/70 p-4 rounded-xl border border-gray-200 flex items-end gap-4">
        ...
        {/* Category Guide */}
        <div className="backdrop-blur-xl bg-white/70 rounded-xl border border-gray-200 p-6">
